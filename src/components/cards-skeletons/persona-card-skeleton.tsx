...
/**
 * Skeleton for PersonaCard — matches the landscape layout:
...
const PersonaCardSkeleton: React.FC<PersonaCardSkeletonProps> = ({ className }) => {
  return (
    ...
    >
      {/* Left: Image area — 40% width, full height (same as PersonaCard) */}
      ...
      {/* Right: Content + Footer — same structure as PersonaCard */}
